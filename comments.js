...
exports.populateComments = void 0;
 ...
 */
function populateComments(userIds, sessionIds) {
    return __awaiter(this, void 0, void 0, function () {
        var client, ids, i, comment, insertQuery, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, client.query('DELETE FROM "comment"')];
                case 3:
                    // Delete existing data from comment table
                    _a.sent();
                    // Reset the auto-increment counter
                    return [4 /*yield*/, client.query('ALTER SEQUENCE "comment_id_seq" RESTART WITH 1')];
                case 4:
                    // Reset the auto-increment counter
                    _a.sent();
                    i = 0;
