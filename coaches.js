...
exports.populateCoaches = void 0;
...
function populateCoaches() {
    return __awaiter(this, void 0, void 0, function () {
        var client, ids, owner, i, coach, insertQuery, result, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, client.query('DELETE FROM "coach"')];
                case 3:
                    // Delete existing data from coach table
                    _b.sent();
                    // Reset the auto-increment counter
                    return [4 /*yield*/, client.query('ALTER SEQUENCE "coach_id_seq" RESTART WITH 1')];
                case 4:
                    // Reset the auto-increment counter
                    _b.sent();
                ...
                case 6:
                    coach = (_a.password_hash = _b.sent(),
                        _a.description = faker_1.faker.lorem.paragraph(),
                        _a.hourly_rate = faker_1.faker.commerce.price(50, 500),
...
exports.populateCoaches = populateCoaches;
