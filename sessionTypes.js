...
exports.populateSessionTypes = void 0;
...
function populateSessionTypes() {
    return __awaiter(this, void 0, void 0, function () {
        var client, ids, name_1, i, session_type, insertQuery, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, client.query('DELETE FROM "session_type"')];
                case 3:
                    // Delete existing data from session_type table
                    _a.sent();
                    // Reset the auto-increment counter
                    return [4 /*yield*/, client.query('ALTER SEQUENCE "session_type_id_seq" RESTART WITH 1')];
                case 4:
                    // Reset the auto-increment counter
                    _a.sent();
                    name_1 = ['Yoga', 'Strength', 'Pilates', 'HIIT', 'Boxing', 'Running', 'Meditation', 'Dance', 'Nutrition', 'Mobility', 'Injury rehab', 'Sports-specific'];
                    i = 0;
                    _a.label = 5;
                case 5:
...
exports.populateSessionTypes = populateSessionTypes;
